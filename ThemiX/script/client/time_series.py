...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', "--number", type=int, default="3", help="the number of client", required=True)
    parser.add_argument('-d', "--directory", type=str, default="./log/", help="directory of client logs",  required=True)
