    ...
    def read_info(self,):
        for i in range(self.n):
            ...
            with open(filename, 'r') as f:
                ...
                tmp = [(int(id), int(size), int(st), int(t)/1000)
                       for id, size, st, t in tmp]
...
if __name__ == "__main__":
    if len(sys.argv) != 6:
        print(
            "usage: python3 analysis.py [number of clients] [request size] [path of log] [name of logfile] [test time]")
